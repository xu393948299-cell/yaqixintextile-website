...
const youtubeMark = '<svg class="yx-youtube-mark" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><rect x="1.25" y="4.25" width="21.5" height="15.5" rx="4.5" fill="#ff0033"></rect><path fill="#fff" d="m10.1 8.55 5.7 3.45-5.7 3.45V8.55Z"></path></svg>';
...
const youtubeLinkMarkup = `<a class="yx-social-link yx-youtube-link" data-social-profile="youtube" href="${youtubeUrl}" target="_blank" rel="noopener noreferrer external" aria-label="Visit YAQIXIN on YouTube">${youtubeMark}<span>YouTube</span></a>`;
...
const socialLinksMarkup = `<div class="yx-social-links" aria-label="YAQIXIN social and messaging contacts">${instagramLinkMarkup}${facebookLinkMarkup}${youtubeLinkMarkup}${wechatLinkMarkup}</div>`;
...
for (const filePath of htmlFiles(root)) {
  ...
  const tagline = relativePath.startsWith("es/")
    ...
    : "Guangzhou wholesale fabric supplier for global apparel sourcing.";
