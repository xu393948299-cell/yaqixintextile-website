(function(){
  ...
  function optionHtml(code){var item=languages[code];return '<button class="language-option" type="button" role="menuitemradio" aria-checked="false" data-lang-option="'+code+'"><span class="language-name"><span class="language-flag" aria-hidden="true"><img src="'+flagBase+item.flag+'" width="24" height="24" alt=""></span><span>'+item.label+'</span></span><small>'+item.short+'</small></button>'}
  function switcherHtml(){var menuId="languageMenu-"+pageId;return '<div class="language-switcher" data-language-switcher><button class="language-trigger" type="button" aria-haspopup="true" aria-expanded="false" aria-controls="'+menuId+'" aria-label="Choose language"><span class="language-mark" aria-hidden="true"><img src="'+flagBase+'us.svg" width="24" height="24" alt=""></span><span data-language-current>EN</span></button><div class="language-menu" id="'+menuId+'" role="menu" aria-label="Choose language">'+order.map(optionHtml).join("")+'</div></div>'}
